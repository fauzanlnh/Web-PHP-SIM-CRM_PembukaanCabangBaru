...
if ($_SESSION['hak_akses'] == 'superadmin') { ?>
  ...
  <ul class="sidebar-menu">
    ...
    if ($_GET["module"] == "pelanggan" || $_GET["module"] == "form_pelanggan") { ?>
      <li class="active">
        <a href="?module=pelanggan"><i class="fa fa-home"></i> Pelanggan </a>
      </li>
    <?php
    }
    // jika tidak, menu home tidak aktif
    ...
    if ($_GET["module"] == "produk" || $_GET["module"] == "form_produk") { ?>
      <li class="active">
        <a href="?module=produk"><i class="fa fa-user"></i> Produk</a>
      </li>
    <?php
    }
    ...
    if ($_GET["module"] == "sablon" || $_GET["module"] == "form_sablon") { ?>
      <li class="active">
        <a href="?module=transaksi"><i class="fa fa-user"></i> Transaksi</a>
      </li>
    <?php
    }
    // jika tidak, menu user tidak aktif
    ...
    if ($_GET["module"] == "kritik_saran") { ?>
      <li class="active">
        <a href="?module=kritik_saran"><i class="fa fa-lock"></i> Kritik dan Saran</a>
      </li>
    <?php
    }
    ...
    if ($_GET["module"] == "spk_cabang_baru") { ?>
      <li class="active">
        <a href="?module=spk_cabang_baru"><i class="fa fa-lock"></i> SPK Cabang Baru</a>
      </li>
    <?php
    }
    // jika tidak, menu ubah password tidak aktif
